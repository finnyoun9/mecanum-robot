/**
 * @file three_motors_debug_main.c
 * @brief Simultaneous open-loop test for front-left, front-right and rear-left.
 *
 * FL: PA2=PWMA/TIM2_CH3, PA4=AIN1, PA5=AIN2, STBY=PB14.
 * FR: PB0=PWMB/TIM3_CH3, PA11=BIN1, PA12=BIN2, STBY=PB14.
 * RL: PB8=PWMA/TIM4_CH3, PB1=AIN1, PB15=AIN2, STBY=PC15.
 */
...
static void motor_gpio_init(void) {
    ...
    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14 | GPIO_PIN_1 | GPIO_PIN_15, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOC, GPIO_PIN_15, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_11 | GPIO_PIN_12,
                      GPIO_PIN_RESET);

    gpio.Pin = GPIO_PIN_14 | GPIO_PIN_1 | GPIO_PIN_15;
    gpio.Mode = GPIO_MODE_OUTPUT_PP;
    gpio.Speed = GPIO_SPEED_FREQ_LOW;
